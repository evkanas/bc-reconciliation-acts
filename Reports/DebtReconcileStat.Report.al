report 70119 "EVK Debt Reconcile Stat."
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Reports/RDLC/ReconsilStatement.rdl';
    Caption = 'Test Report', Comment = 'lt-LT="Suderinimo akto bandomoji ataskaita"';
    ...
    dataset
    {
        dataitem("EVK Reconcil. Statement Header"; "EVK Reconcil. Statement Header")
        {
            ...
            column(Employeesignature; Employee."EVK Employee Signature") { }
            ...
            begin
                ...
                if languageIntCode = 1033 then
                    documentDate := "EVK ReconsilStatement".getEnglishDate("Document Date");
                ...
                if languageIntCode = 1033 then
                    reconcileDate := "EVK ReconsilStatement".getEnglishDate("Reconcile Date");
                case type of
                    Type::"Customer":
                        begin
                            SpecifiedDebtAmountTxt := SpecifiedDebtAmountLbl;
                ...
                "EVK Debt Reconciliation Setup".Get();
                Char10 := 10;
                if "EVK Debt Reconciliation Setup"."Statement E-mail" <> '' then
                    InformationTextTxt += ', ' + "EVK Debt Reconciliation Setup"."Statement E-mail" + '.';
                ...
                if ("Language Code" = '') or ("Language Code" = 'LTH') then BEGIN
                    if "EVK Debt Reconciliation Setup"."Additional Text" <> '' then
                        InformationTextTxt += format(Char10) + format(Char10) + "EVK Debt Reconciliation Setup"."Additional Text";
                END
                else
                    if "EVK Debt Reconciliation Setup"."Additional Text ENU" <> '' then
                        InformationTextTxt += format(Char10) + format(Char10) + "EVK Debt Reconciliation Setup"."Additional Text ENU";
                ...
                Clear("EVK ReconsilStatement");
                DebtAmountInWords := "EVK ReconsilStatement".AmountInWordsByLangugae(ABS("Remaining Amt. (LCY)"), languageIntCode);
                FulNoTxt := NoLbl + "No.";
            end;
        }
    ...
    var
        "EVK Debt Reconciliation Setup": Record "EVK Debt Reconciliation Setup";
        CompanyInformation: Record "Company Information";
        Employee: Record Employee;
        "EVK ReconsilStatement": Codeunit "EVK ReconsilStatement";
        Counter: Integer;
        ...
        Char10: char;
        DebtReconciliationStatementLbl: Label 'Debt reconciliation statement', Comment = 'lt-LT="Suderinimo akto pavadinimas"';
        ...
        PleaseConfirmCustomerLbl: Label 'Please confirm that the below indicated sum is your company ', Comment = 'lt-LT="Prašome patvirtinti, kad žemiau nurodyta suma yra jūsų kompanijos"';
        PleaseConfirmVendorLbl: Label 'Please confirm that the below indicated sum is our company ', Comment = 'lt-LT="Prašome patvirtinti, kad žemiau nurodyta suma yra mūsų kompanijos"';
        ToYourCompanyLbl: Label ' to your company ', Comment = 'lt-LT="jūsų kompanijai"';
        ToOurCompanyLbl: Label ' to our company ', Comment = 'lt-LT="mūsų kompanijai"';
        DebtSkolaLbl: Label 'debt ', Comment = 'lt-LT="skola"';
        OverpaymentSkolaLbl: Label 'overpayment ', Comment = 'lt-LT="permokėjimas"';
        ...
        AccountantLbl: Label 'Accountant', Comment = 'lt-LT="Apskaitos darbuotojas"';
        DebtLbl: Label 'Debt', Comment = 'lt-LT="Skola"';
        OverpaymentLbl: Label 'Overpayment', Comment = 'lt-LT="Permokėjimas"';
        NameLastNameSignatureLbl: Label '(Name, Last name, Signature)', Comment = 'lt-LT="(Vardas, Pavardė, Parašas)"';
        SpecifiedOverpayedAmountLbl: Label 'Your specified overpayed amount', Comment = 'lt-LT="Jūsų nurodyta permokėjimo suma"';
        SpecifiedDebtAmountLbl: Label 'Your specified debt amount', Comment = 'lt-LT="Jūsų nurodyta skolos suma"';
        IsCorrectOnlyLbl: Label 'is correct only with these exceptions', Comment = 'lt-LT="yra teisinga tik su šiais išimtimis"';
        OneConfirmedCopyOfDebtsReconsilationStatementLbl: Label 'One confirmed copy of Debts Reconsilation Statement please returnt to: ', Comment = 'lt-LT="Vienas patvirtintas skolų konsolidavimo ataskaitos kopijas prašome grąžinti į: "';
        Address_Lbl: Label ' address ', Comment = 'lt-LT=" adresas "';
        SinceWeHaveNotReceivedDebtConfirmationLbl: Label 'Since we have not received any debt confirmation protocol from you, the sum indicated in the protocol shall be considered to be the right one.', Comment = 'lt-LT="Nes musų nereikia gauti jokio skolos patvirtinimo protokolo iš jūsų, protokole nurodyta suma bus laikoma teisinga."';
        ...
        bPositive: Boolean;
        BalanceAtTheBeginningOfThePeriodLbl: Label 'Balance at the beginning of the period', Comment = 'lt-LT="Balansas periodo pradžioje"';
        BalanceAtEndOfPeriodLbl: Label 'Balance at the end of the period', Comment = 'lt-LT="Balansas periodo pabaigoje"';
